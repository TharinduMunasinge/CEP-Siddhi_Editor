...
var SiddhiQLGrammarVisitor = require('./SiddhiQLGrammarVisitor').SiddhiQLGrammarVisitor;


	//import org.wso2.siddhi.query.compiler.exception.SiddhiParserException;

var grammarFileName = "SiddhiQLGrammar.g4";
...
function SiddhiQLGrammarParser (input) {
...
SiddhiQLGrammarParser.prototype = Object.create(antlr4.Parser.prototype);
SiddhiQLGrammarParser.prototype.constructor = SiddhiQLGrammarParser;

Object.defineProperty(SiddhiQLGrammarParser.prototype, "atn", {
	get : function() {
		return atn;
	}
});

SiddhiQLGrammarParser.EOF = antlr4.Token.EOF;
SiddhiQLGrammarParser.INT_LITERAL = 1;
SiddhiQLGrammarParser.LONG_LITERAL = 2;
SiddhiQLGrammarParser.FLOAT_LITERAL = 3;
SiddhiQLGrammarParser.DOUBLE_LITERAL = 4;
SiddhiQLGrammarParser.COL = 5;
SiddhiQLGrammarParser.SCOL = 6;
SiddhiQLGrammarParser.DOT = 7;
SiddhiQLGrammarParser.OPEN_PAR = 8;
SiddhiQLGrammarParser.CLOSE_PAR = 9;
SiddhiQLGrammarParser.OPEN_SQARE_BRACKETS = 10;
SiddhiQLGrammarParser.CLOASE_SQARE_BRACKETS = 11;
SiddhiQLGrammarParser.COMMA = 12;
SiddhiQLGrammarParser.ASSIGN = 13;
SiddhiQLGrammarParser.STAR = 14;
SiddhiQLGrammarParser.PLUS = 15;
SiddhiQLGrammarParser.QUESTION = 16;
SiddhiQLGrammarParser.MINUS = 17;
SiddhiQLGrammarParser.DIV = 18;
SiddhiQLGrammarParser.MOD = 19;
SiddhiQLGrammarParser.LT = 20;
SiddhiQLGrammarParser.LT_EQ = 21;
SiddhiQLGrammarParser.GT = 22;
SiddhiQLGrammarParser.GT_EQ = 23;
SiddhiQLGrammarParser.EQ = 24;
SiddhiQLGrammarParser.NOT_EQ = 25;
SiddhiQLGrammarParser.AT = 26;
SiddhiQLGrammarParser.FOLLOWED_BY = 27;
SiddhiQLGrammarParser.HASH = 28;
SiddhiQLGrammarParser.STREAM = 29;
SiddhiQLGrammarParser.DEFINE = 30;
SiddhiQLGrammarParser.FUNCTION = 31;
SiddhiQLGrammarParser.TABLE = 32;
SiddhiQLGrammarParser.PLAN = 33;
SiddhiQLGrammarParser.FROM = 34;
SiddhiQLGrammarParser.PARTITION = 35;
SiddhiQLGrammarParser.WINDOW = 36;
SiddhiQLGrammarParser.SELECT = 37;
SiddhiQLGrammarParser.GROUP = 38;
SiddhiQLGrammarParser.BY = 39;
SiddhiQLGrammarParser.HAVING = 40;
SiddhiQLGrammarParser.INSERT = 41;
SiddhiQLGrammarParser.DELETE = 42;
SiddhiQLGrammarParser.UPDATE = 43;
SiddhiQLGrammarParser.RETURN = 44;
SiddhiQLGrammarParser.EVENTS = 45;
SiddhiQLGrammarParser.INTO = 46;
SiddhiQLGrammarParser.OUTPUT = 47;
SiddhiQLGrammarParser.EXPIRED = 48;
SiddhiQLGrammarParser.CURRENT = 49;
SiddhiQLGrammarParser.SNAPSHOT = 50;
SiddhiQLGrammarParser.FOR = 51;
SiddhiQLGrammarParser.RAW = 52;
SiddhiQLGrammarParser.OF = 53;
SiddhiQLGrammarParser.AS = 54;
SiddhiQLGrammarParser.OR = 55;
SiddhiQLGrammarParser.AND = 56;
SiddhiQLGrammarParser.IN = 57;
SiddhiQLGrammarParser.ON = 58;
SiddhiQLGrammarParser.IS = 59;
SiddhiQLGrammarParser.NOT = 60;
SiddhiQLGrammarParser.WITHIN = 61;
SiddhiQLGrammarParser.WITH = 62;
SiddhiQLGrammarParser.BEGIN = 63;
SiddhiQLGrammarParser.END = 64;
SiddhiQLGrammarParser.NULL = 65;
SiddhiQLGrammarParser.EVERY = 66;
SiddhiQLGrammarParser.LAST = 67;
SiddhiQLGrammarParser.ALL = 68;
SiddhiQLGrammarParser.FIRST = 69;
SiddhiQLGrammarParser.JOIN = 70;
SiddhiQLGrammarParser.INNER = 71;
SiddhiQLGrammarParser.OUTER = 72;
SiddhiQLGrammarParser.RIGHT = 73;
SiddhiQLGrammarParser.LEFT = 74;
SiddhiQLGrammarParser.FULL = 75;
SiddhiQLGrammarParser.UNIDIRECTIONAL = 76;
SiddhiQLGrammarParser.YEARS = 77;
SiddhiQLGrammarParser.MONTHS = 78;
SiddhiQLGrammarParser.WEEKS = 79;
SiddhiQLGrammarParser.DAYS = 80;
SiddhiQLGrammarParser.HOURS = 81;
SiddhiQLGrammarParser.MINUTES = 82;
SiddhiQLGrammarParser.SECONDS = 83;
SiddhiQLGrammarParser.MILLISECONDS = 84;
SiddhiQLGrammarParser.FALSE = 85;
SiddhiQLGrammarParser.TRUE = 86;
SiddhiQLGrammarParser.STRING = 87;
SiddhiQLGrammarParser.INT = 88;
SiddhiQLGrammarParser.LONG = 89;
SiddhiQLGrammarParser.FLOAT = 90;
SiddhiQLGrammarParser.DOUBLE = 91;
SiddhiQLGrammarParser.BOOL = 92;
SiddhiQLGrammarParser.OBJECT = 93;
SiddhiQLGrammarParser.ID_QUOTES = 94;
SiddhiQLGrammarParser.ID = 95;
SiddhiQLGrammarParser.STRING_LITERAL = 96;
SiddhiQLGrammarParser.SINGLE_LINE_COMMENT = 97;
SiddhiQLGrammarParser.MULTILINE_COMMENT = 98;
SiddhiQLGrammarParser.SPACES = 99;
SiddhiQLGrammarParser.UNEXPECTED_CHAR = 100;
SiddhiQLGrammarParser.SCRIPT = 101;

SiddhiQLGrammarParser.RULE_parse = 0;
SiddhiQLGrammarParser.RULE_error = 1;
SiddhiQLGrammarParser.RULE_execution_plan = 2;
SiddhiQLGrammarParser.RULE_execution_element = 3;
SiddhiQLGrammarParser.RULE_definition_stream_final = 4;
SiddhiQLGrammarParser.RULE_definition_stream = 5;
SiddhiQLGrammarParser.RULE_definition_table_final = 6;
SiddhiQLGrammarParser.RULE_definition_table = 7;
SiddhiQLGrammarParser.RULE_definition_function_final = 8;
SiddhiQLGrammarParser.RULE_definition_function = 9;
SiddhiQLGrammarParser.RULE_function_name = 10;
SiddhiQLGrammarParser.RULE_language_name = 11;
SiddhiQLGrammarParser.RULE_function_body = 12;
SiddhiQLGrammarParser.RULE_annotation = 13;
SiddhiQLGrammarParser.RULE_plan_annotation = 14;
SiddhiQLGrammarParser.RULE_annotation_element = 15;
SiddhiQLGrammarParser.RULE_partition = 16;
SiddhiQLGrammarParser.RULE_partition_final = 17;
SiddhiQLGrammarParser.RULE_partition_with_stream = 18;
SiddhiQLGrammarParser.RULE_condition_ranges = 19;
SiddhiQLGrammarParser.RULE_condition_range = 20;
SiddhiQLGrammarParser.RULE_query_final = 21;
SiddhiQLGrammarParser.RULE_query = 22;
SiddhiQLGrammarParser.RULE_query_input = 23;
SiddhiQLGrammarParser.RULE_standard_stream = 24;
SiddhiQLGrammarParser.RULE_join_stream = 25;
SiddhiQLGrammarParser.RULE_join_source = 26;
SiddhiQLGrammarParser.RULE_pattern_stream = 27;
SiddhiQLGrammarParser.RULE_every_pattern_source_chain = 28;
SiddhiQLGrammarParser.RULE_pattern_source_chain = 29;
SiddhiQLGrammarParser.RULE_pattern_source = 30;
SiddhiQLGrammarParser.RULE_logical_stateful_source = 31;
SiddhiQLGrammarParser.RULE_pattern_collection_stateful_source = 32;
SiddhiQLGrammarParser.RULE_standard_stateful_source = 33;
SiddhiQLGrammarParser.RULE_basic_source = 34;
SiddhiQLGrammarParser.RULE_basic_source_stream_handlers = 35;
SiddhiQLGrammarParser.RULE_basic_source_stream_handler = 36;
SiddhiQLGrammarParser.RULE_sequence_stream = 37;
SiddhiQLGrammarParser.RULE_sequence_source_chain = 38;
SiddhiQLGrammarParser.RULE_sequence_source = 39;
SiddhiQLGrammarParser.RULE_sequence_collection_stateful_source = 40;
SiddhiQLGrammarParser.RULE_anonymous_stream = 41;
SiddhiQLGrammarParser.RULE_filter = 42;
SiddhiQLGrammarParser.RULE_stream_function = 43;
SiddhiQLGrammarParser.RULE_window = 44;
SiddhiQLGrammarParser.RULE_query_section = 45;
SiddhiQLGrammarParser.RULE_group_by = 46;
SiddhiQLGrammarParser.RULE_having = 47;
SiddhiQLGrammarParser.RULE_query_output = 48;
SiddhiQLGrammarParser.RULE_output_event_type = 49;
SiddhiQLGrammarParser.RULE_output_rate = 50;
SiddhiQLGrammarParser.RULE_output_rate_type = 51;
SiddhiQLGrammarParser.RULE_within_time = 52;
SiddhiQLGrammarParser.RULE_output_attribute = 53;
SiddhiQLGrammarParser.RULE_attribute = 54;
SiddhiQLGrammarParser.RULE_expression = 55;
SiddhiQLGrammarParser.RULE_math_operation = 56;
SiddhiQLGrammarParser.RULE_function_operation = 57;
SiddhiQLGrammarParser.RULE_attribute_list = 58;
SiddhiQLGrammarParser.RULE_null_check = 59;
SiddhiQLGrammarParser.RULE_stream_reference = 60;
SiddhiQLGrammarParser.RULE_attribute_reference = 61;
SiddhiQLGrammarParser.RULE_attribute_index = 62;
SiddhiQLGrammarParser.RULE_function_id = 63;
SiddhiQLGrammarParser.RULE_function_namespace = 64;
SiddhiQLGrammarParser.RULE_stream_id = 65;
SiddhiQLGrammarParser.RULE_stream_alias = 66;
SiddhiQLGrammarParser.RULE_property_name = 67;
SiddhiQLGrammarParser.RULE_attribute_name = 68;
SiddhiQLGrammarParser.RULE_property_value = 69;
SiddhiQLGrammarParser.RULE_source = 70;
SiddhiQLGrammarParser.RULE_target = 71;
SiddhiQLGrammarParser.RULE_event = 72;
SiddhiQLGrammarParser.RULE_name = 73;
SiddhiQLGrammarParser.RULE_collect = 74;
SiddhiQLGrammarParser.RULE_attribute_type = 75;
SiddhiQLGrammarParser.RULE_join = 76;
SiddhiQLGrammarParser.RULE_constant_value = 77;
SiddhiQLGrammarParser.RULE_id = 78;
SiddhiQLGrammarParser.RULE_keyword = 79;
SiddhiQLGrammarParser.RULE_time_value = 80;
SiddhiQLGrammarParser.RULE_year_value = 81;
SiddhiQLGrammarParser.RULE_month_value = 82;
SiddhiQLGrammarParser.RULE_week_value = 83;
SiddhiQLGrammarParser.RULE_day_value = 84;
SiddhiQLGrammarParser.RULE_hour_value = 85;
SiddhiQLGrammarParser.RULE_minute_value = 86;
SiddhiQLGrammarParser.RULE_second_value = 87;
SiddhiQLGrammarParser.RULE_millisecond_value = 88;
SiddhiQLGrammarParser.RULE_signed_double_value = 89;
SiddhiQLGrammarParser.RULE_signed_long_value = 90;
SiddhiQLGrammarParser.RULE_signed_float_value = 91;
SiddhiQLGrammarParser.RULE_signed_int_value = 92;
SiddhiQLGrammarParser.RULE_bool_value = 93;
SiddhiQLGrammarParser.RULE_string_value = 94;
...
function ParseContext(parser, parent, invokingState) {
    ...
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_parse;
    return this;
}
...
ParseContext.prototype.EOF = function() {
    return this.getToken(SiddhiQLGrammarParser.EOF, 0);
};

ParseContext.prototype.enterRule = function(listener) {
    if(listener instanceof SiddhiQLGrammarListener ) {
...
ParseContext.prototype.accept = function(visitor) {
    if ( visitor instanceof SiddhiQLGrammarVisitor ) {
...
SiddhiQLGrammarParser.prototype.parse = function() {

    var localctx = new ParseContext(this, this._ctx, this.state);
    this.enterRule(localctx, 0, SiddhiQLGrammarParser.RULE_parse);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 190; 
        this.execution_plan();
        this.state = 191;
        this.match(SiddhiQLGrammarParser.EOF);
    } catch (re) {
...
function ErrorContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_error;
    return this;
}
...
ErrorContext.prototype.UNEXPECTED_CHAR = function() {
    return this.getToken(SiddhiQLGrammarParser.UNEXPECTED_CHAR, 0);
};
...
SiddhiQLGrammarParser.prototype.error = function() {

    var localctx = new ErrorContext(this, this._ctx, this.state);
    this.enterRule(localctx, 2, SiddhiQLGrammarParser.RULE_error);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 193;
        this.match(SiddhiQLGrammarParser.UNEXPECTED_CHAR);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Execution_planContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_execution_plan;
    return this;
}
...
SiddhiQLGrammarParser.prototype.execution_plan = function() {

    var localctx = new Execution_planContext(this, this._ctx, this.state);
    this.enterRule(localctx, 4, SiddhiQLGrammarParser.RULE_execution_plan);
    ...
    try {
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case SiddhiQLGrammarParser.AT:
                    this.state = 195; 
                    this.plan_annotation();
                    break;
                case SiddhiQLGrammarParser.UNEXPECTED_CHAR:
                    this.state = 196; 
                    this.error();
                    break;
                default:
        ...
        case 1:
            ...
            while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
                if(_alt===1) {
                    this.state = 208;
                    this.match(SiddhiQLGrammarParser.SCOL);
                    this.state = 213;
            ...
            if(_la===SiddhiQLGrammarParser.SCOL) {
                this.state = 220;
                this.match(SiddhiQLGrammarParser.SCOL);
            }
        ...
        case 3:
            ...
            switch(this._input.LA(1)) {
            case SiddhiQLGrammarParser.AT:
            case SiddhiQLGrammarParser.FROM:
            case SiddhiQLGrammarParser.PARTITION:
                this.state = 224; 
...
function Execution_elementContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_execution_element;
    return this;
}
...
SiddhiQLGrammarParser.prototype.execution_element = function() {

    var localctx = new Execution_elementContext(this, this._ctx, this.state);
    this.enterRule(localctx, 6, SiddhiQLGrammarParser.RULE_execution_element);
    try {
        this.state = 277;
...
function Definition_stream_finalContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_definition_stream_final;
    return this;
}
...
SiddhiQLGrammarParser.prototype.definition_stream_final = function() {

    var localctx = new Definition_stream_finalContext(this, this._ctx, this.state);
    this.enterRule(localctx, 8, SiddhiQLGrammarParser.RULE_definition_stream_final);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 279; 
...
function Definition_streamContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_definition_stream;
    return this;
}
...
Definition_streamContext.prototype.DEFINE = function() {
    return this.getToken(SiddhiQLGrammarParser.DEFINE, 0);
};

Definition_streamContext.prototype.STREAM = function() {
    return this.getToken(SiddhiQLGrammarParser.STREAM, 0);
};
...
SiddhiQLGrammarParser.prototype.definition_stream = function() {

    var localctx = new Definition_streamContext(this, this._ctx, this.state);
    this.enterRule(localctx, 10, SiddhiQLGrammarParser.RULE_definition_stream);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 288;
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(_la===SiddhiQLGrammarParser.AT) {
            this.state = 285; 
            this.annotation();
            this.state = 290;
            this._errHandler.sync(this);
        ...
        this.state = 291;
        this.match(SiddhiQLGrammarParser.DEFINE);
        this.state = 292;
        this.match(SiddhiQLGrammarParser.STREAM);
        this.state = 293; 
        this.source();
        this.state = 294;
        this.match(SiddhiQLGrammarParser.OPEN_PAR);
        this.state = 295; 
        this.attribute_name();
        this.state = 296; 
        this.attribute_type();
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(_la===SiddhiQLGrammarParser.COMMA) {
            this.state = 297;
            this.match(SiddhiQLGrammarParser.COMMA);
            this.state = 298; 
            this.attribute_name();
            this.state = 299; 
            this.attribute_type();
        ...
        this.state = 306;
        this.match(SiddhiQLGrammarParser.CLOSE_PAR);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Definition_table_finalContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_definition_table_final;
    return this;
}
...
SiddhiQLGrammarParser.prototype.definition_table_final = function() {

    var localctx = new Definition_table_finalContext(this, this._ctx, this.state);
    this.enterRule(localctx, 12, SiddhiQLGrammarParser.RULE_definition_table_final);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 308; 
...
function Definition_tableContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_definition_table;
    return this;
}
...
Definition_tableContext.prototype.TABLE = function() {
    return this.getToken(SiddhiQLGrammarParser.TABLE, 0);
};
...
SiddhiQLGrammarParser.prototype.definition_table = function() {

    var localctx = new Definition_tableContext(this, this._ctx, this.state);
    this.enterRule(localctx, 14, SiddhiQLGrammarParser.RULE_definition_table);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 317;
        ...
        this.match(SiddhiQLGrammarParser.DEFINE);
        this.state = 321;
        this.match(SiddhiQLGrammarParser.TABLE);
        this.state = 322; 
        this.source();
        this.state = 323;
        this.match(SiddhiQLGrammarParser.OPEN_PAR);
...
function Definition_function_finalContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_definition_function_final;
    return this;
}
...
SiddhiQLGrammarParser.prototype.definition_function_final = function() {

    var localctx = new Definition_function_finalContext(this, this._ctx, this.state);
    this.enterRule(localctx, 16, SiddhiQLGrammarParser.RULE_definition_function_final);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 337; 
...
function Definition_functionContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_definition_function;
    return this;
}
...
Definition_functionContext.prototype.FUNCTION = function() {
    return this.getToken(SiddhiQLGrammarParser.FUNCTION, 0);
};
...
Definition_functionContext.prototype.RETURN = function() {
    return this.getToken(SiddhiQLGrammarParser.RETURN, 0);
};
...
SiddhiQLGrammarParser.prototype.definition_function = function() {

    var localctx = new Definition_functionContext(this, this._ctx, this.state);
    this.enterRule(localctx, 18, SiddhiQLGrammarParser.RULE_definition_function);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 343;
        this.match(SiddhiQLGrammarParser.DEFINE);
        this.state = 344;
        this.match(SiddhiQLGrammarParser.FUNCTION);
        this.state = 345; 
        this.function_name();
        this.state = 346;
        this.match(SiddhiQLGrammarParser.OPEN_SQARE_BRACKETS);
        this.state = 347; 
        this.language_name();
        this.state = 348;
        this.match(SiddhiQLGrammarParser.CLOASE_SQARE_BRACKETS);
        this.state = 349;
        this.match(SiddhiQLGrammarParser.RETURN);
        this.state = 350; 
        this.attribute_type();
        this.state = 351; 
        this.function_body();
...
function Function_nameContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_function_name;
    return this;
}
...
SiddhiQLGrammarParser.prototype.function_name = function() {

    var localctx = new Function_nameContext(this, this._ctx, this.state);
    this.enterRule(localctx, 20, SiddhiQLGrammarParser.RULE_function_name);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 353; 
        this.id();
...
function Language_nameContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_language_name;
    return this;
}
...
SiddhiQLGrammarParser.prototype.language_name = function() {

    var localctx = new Language_nameContext(this, this._ctx, this.state);
    this.enterRule(localctx, 22, SiddhiQLGrammarParser.RULE_language_name);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 355; 
        this.id();
...
function Function_bodyContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_function_body;
    return this;
}
...
Function_bodyContext.prototype.SCRIPT = function() {
    return this.getToken(SiddhiQLGrammarParser.SCRIPT, 0);
};
...
SiddhiQLGrammarParser.prototype.function_body = function() {

    var localctx = new Function_bodyContext(this, this._ctx, this.state);
    this.enterRule(localctx, 24, SiddhiQLGrammarParser.RULE_function_body);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 357;
        this.match(SiddhiQLGrammarParser.SCRIPT);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function AnnotationContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_annotation;
    return this;
}
...
SiddhiQLGrammarParser.prototype.annotation = function() {

    var localctx = new AnnotationContext(this, this._ctx, this.state);
    this.enterRule(localctx, 26, SiddhiQLGrammarParser.RULE_annotation);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 359;
        this.match(SiddhiQLGrammarParser.AT);
        this.state = 360; 
        this.name();
        this.state = 372;
        _la = this._input.LA(1);
        if(_la===SiddhiQLGrammarParser.OPEN_PAR) {
            this.state = 361;
            this.match(SiddhiQLGrammarParser.OPEN_PAR);
            this.state = 362; 
...
function Plan_annotationContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_plan_annotation;
    return this;
}
...
Plan_annotationContext.prototype.PLAN = function() {
    return this.getToken(SiddhiQLGrammarParser.PLAN, 0);
};
...
SiddhiQLGrammarParser.prototype.plan_annotation = function() {

    var localctx = new Plan_annotationContext(this, this._ctx, this.state);
    this.enterRule(localctx, 28, SiddhiQLGrammarParser.RULE_plan_annotation);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 374;
        this.match(SiddhiQLGrammarParser.AT);
        this.state = 375;
        this.match(SiddhiQLGrammarParser.PLAN);
        this.state = 376;
        this.match(SiddhiQLGrammarParser.COL);
        this.state = 377; 
        this.name();
        this.state = 389;
        _la = this._input.LA(1);
...
function Annotation_elementContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_annotation_element;
    return this;
}
...
SiddhiQLGrammarParser.prototype.annotation_element = function() {

    var localctx = new Annotation_elementContext(this, this._ctx, this.state);
    this.enterRule(localctx, 30, SiddhiQLGrammarParser.RULE_annotation_element);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 394;
        _la = this._input.LA(1);
        if(_la===SiddhiQLGrammarParser.STREAM || _la===SiddhiQLGrammarParser.DEFINE || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (SiddhiQLGrammarParser.TABLE - 32)) | (1 << (SiddhiQLGrammarParser.FROM - 32)) | (1 << (SiddhiQLGrammarParser.PARTITION - 32)) | (1 << (SiddhiQLGrammarParser.WINDOW - 32)) | (1 << (SiddhiQLGrammarParser.SELECT - 32)) | (1 << (SiddhiQLGrammarParser.GROUP - 32)) | (1 << (SiddhiQLGrammarParser.BY - 32)) | (1 << (SiddhiQLGrammarParser.HAVING - 32)) | (1 << (SiddhiQLGrammarParser.INSERT - 32)) | (1 << (SiddhiQLGrammarParser.DELETE - 32)) | (1 << (SiddhiQLGrammarParser.UPDATE - 32)) | (1 << (SiddhiQLGrammarParser.RETURN - 32)) | (1 << (SiddhiQLGrammarParser.EVENTS - 32)) | (1 << (SiddhiQLGrammarParser.INTO - 32)) | (1 << (SiddhiQLGrammarParser.OUTPUT - 32)) | (1 << (SiddhiQLGrammarParser.EXPIRED - 32)) | (1 << (SiddhiQLGrammarParser.CURRENT - 32)) | (1 << (SiddhiQLGrammarParser.SNAPSHOT - 32)) | (1 << (SiddhiQLGrammarParser.FOR - 32)) | (1 << (SiddhiQLGrammarParser.RAW - 32)) | (1 << (SiddhiQLGrammarParser.OF - 32)) | (1 << (SiddhiQLGrammarParser.AS - 32)) | (1 << (SiddhiQLGrammarParser.OR - 32)) | (1 << (SiddhiQLGrammarParser.AND - 32)) | (1 << (SiddhiQLGrammarParser.ON - 32)) | (1 << (SiddhiQLGrammarParser.IS - 32)) | (1 << (SiddhiQLGrammarParser.NOT - 32)) | (1 << (SiddhiQLGrammarParser.WITHIN - 32)) | (1 << (SiddhiQLGrammarParser.WITH - 32)) | (1 << (SiddhiQLGrammarParser.BEGIN - 32)))) !== 0) || ((((_la - 64)) & ~0x1f) == 0 && ((1 << (_la - 64)) & ((1 << (SiddhiQLGrammarParser.END - 64)) | (1 << (SiddhiQLGrammarParser.NULL - 64)) | (1 << (SiddhiQLGrammarParser.EVERY - 64)) | (1 << (SiddhiQLGrammarParser.LAST - 64)) | (1 << (SiddhiQLGrammarParser.ALL - 64)) | (1 << (SiddhiQLGrammarParser.FIRST - 64)) | (1 << (SiddhiQLGrammarParser.JOIN - 64)) | (1 << (SiddhiQLGrammarParser.INNER - 64)) | (1 << (SiddhiQLGrammarParser.OUTER - 64)) | (1 << (SiddhiQLGrammarParser.RIGHT - 64)) | (1 << (SiddhiQLGrammarParser.LEFT - 64)) | (1 << (SiddhiQLGrammarParser.FULL - 64)) | (1 << (SiddhiQLGrammarParser.UNIDIRECTIONAL - 64)) | (1 << (SiddhiQLGrammarParser.YEARS - 64)) | (1 << (SiddhiQLGrammarParser.MONTHS - 64)) | (1 << (SiddhiQLGrammarParser.WEEKS - 64)) | (1 << (SiddhiQLGrammarParser.DAYS - 64)) | (1 << (SiddhiQLGrammarParser.HOURS - 64)) | (1 << (SiddhiQLGrammarParser.MINUTES - 64)) | (1 << (SiddhiQLGrammarParser.SECONDS - 64)) | (1 << (SiddhiQLGrammarParser.MILLISECONDS - 64)) | (1 << (SiddhiQLGrammarParser.FALSE - 64)) | (1 << (SiddhiQLGrammarParser.TRUE - 64)) | (1 << (SiddhiQLGrammarParser.STRING - 64)) | (1 << (SiddhiQLGrammarParser.INT - 64)) | (1 << (SiddhiQLGrammarParser.LONG - 64)) | (1 << (SiddhiQLGrammarParser.FLOAT - 64)) | (1 << (SiddhiQLGrammarParser.DOUBLE - 64)) | (1 << (SiddhiQLGrammarParser.BOOL - 64)) | (1 << (SiddhiQLGrammarParser.OBJECT - 64)) | (1 << (SiddhiQLGrammarParser.ID_QUOTES - 64)) | (1 << (SiddhiQLGrammarParser.ID - 64)))) !== 0)) {
            this.state = 391; 
            this.property_name();
            this.state = 392;
            this.match(SiddhiQLGrammarParser.ASSIGN);
        }
...
function PartitionContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_partition;
    return this;
}
...
PartitionContext.prototype.PARTITION = function() {
    return this.getToken(SiddhiQLGrammarParser.PARTITION, 0);
};

PartitionContext.prototype.WITH = function() {
    return this.getToken(SiddhiQLGrammarParser.WITH, 0);
};
...
PartitionContext.prototype.BEGIN = function() {
    return this.getToken(SiddhiQLGrammarParser.BEGIN, 0);
};

PartitionContext.prototype.END = function() {
    return this.getToken(SiddhiQLGrammarParser.END, 0);
};
...
SiddhiQLGrammarParser.prototype.partition = function() {

    var localctx = new PartitionContext(this, this._ctx, this.state);
    this.enterRule(localctx, 32, SiddhiQLGrammarParser.RULE_partition);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 401;
        ...
        this.state = 404;
        this.match(SiddhiQLGrammarParser.PARTITION);
        this.state = 405;
        this.match(SiddhiQLGrammarParser.WITH);
        this.state = 406;
        this.match(SiddhiQLGrammarParser.OPEN_PAR);
        this.state = 407; 
        ...
        this.match(SiddhiQLGrammarParser.CLOSE_PAR);
        this.state = 416;
        this.match(SiddhiQLGrammarParser.BEGIN);
        this.state = 419;
        switch(this._input.LA(1)) {
        case SiddhiQLGrammarParser.AT:
        case SiddhiQLGrammarParser.FROM:
        ...
        this.state = 434;
        this.match(SiddhiQLGrammarParser.END);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Partition_finalContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_partition_final;
    return this;
}
...
SiddhiQLGrammarParser.prototype.partition_final = function() {

    var localctx = new Partition_finalContext(this, this._ctx, this.state);
    this.enterRule(localctx, 34, SiddhiQLGrammarParser.RULE_partition_final);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 436; 
...
function Partition_with_streamContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_partition_with_stream;
    return this;
}
...
Partition_with_streamContext.prototype.OF = function() {
    return this.getToken(SiddhiQLGrammarParser.OF, 0);
};
...
SiddhiQLGrammarParser.prototype.partition_with_stream = function() {

    var localctx = new Partition_with_streamContext(this, this._ctx, this.state);
    this.enterRule(localctx, 36, SiddhiQLGrammarParser.RULE_partition_with_stream);
    try {
        this.state = 450;
        ...
        case 1:
            ...
            this.attribute();
            this.state = 443;
            this.match(SiddhiQLGrammarParser.OF);
            this.state = 444; 
            this.stream_id();
            break;
...
function Condition_rangesContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_condition_ranges;
    return this;
}
...
Condition_rangesContext.prototype.OR = function(i) {
    ...
    if(i===null) {
        return this.getTokens(SiddhiQLGrammarParser.OR);
    } else {
        return this.getToken(SiddhiQLGrammarParser.OR, i);
    }
};
...
SiddhiQLGrammarParser.prototype.condition_ranges = function() {

    var localctx = new Condition_rangesContext(this, this._ctx, this.state);
    this.enterRule(localctx, 38, SiddhiQLGrammarParser.RULE_condition_ranges);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 452; 
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(_la===SiddhiQLGrammarParser.OR) {
            this.state = 453;
            this.match(SiddhiQLGrammarParser.OR);
            this.state = 454; 
            this.condition_range();
            this.state = 459;
            this._errHandler.sync(this);
...
function Condition_rangeContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_condition_range;
    return this;
}
...
Condition_rangeContext.prototype.AS = function() {
    return this.getToken(SiddhiQLGrammarParser.AS, 0);
};
...
SiddhiQLGrammarParser.prototype.condition_range = function() {

    var localctx = new Condition_rangeContext(this, this._ctx, this.state);
    this.enterRule(localctx, 40, SiddhiQLGrammarParser.RULE_condition_range);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 460; 
        this.expression();
        this.state = 461;
        this.match(SiddhiQLGrammarParser.AS);
        this.state = 462; 
        this.string_value();
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
...
function Query_finalContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_query_final;
    return this;
}
...
SiddhiQLGrammarParser.prototype.query_final = function() {

    var localctx = new Query_finalContext(this, this._ctx, this.state);
    this.enterRule(localctx, 42, SiddhiQLGrammarParser.RULE_query_final);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 464; 
...
function QueryContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_query;
    return this;
}
...
QueryContext.prototype.FROM = function() {
    return this.getToken(SiddhiQLGrammarParser.FROM, 0);
};
...
SiddhiQLGrammarParser.prototype.query = function() {

    var localctx = new QueryContext(this, this._ctx, this.state);
    this.enterRule(localctx, 44, SiddhiQLGrammarParser.RULE_query);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 473;
        ...
        this.state = 476;
        this.match(SiddhiQLGrammarParser.FROM);
        this.state = 477; 
        this.query_input();
        this.state = 479;
        _la = this._input.LA(1);
        if(_la===SiddhiQLGrammarParser.SELECT) {
            this.state = 478; 
            this.query_section();
        }
        ...
        this.state = 482;
        _la = this._input.LA(1);
        if(_la===SiddhiQLGrammarParser.OUTPUT) {
            this.state = 481; 
            this.output_rate();
        }
...
function Query_inputContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_query_input;
    return this;
}
...
SiddhiQLGrammarParser.prototype.query_input = function() {

    var localctx = new Query_inputContext(this, this._ctx, this.state);
    this.enterRule(localctx, 46, SiddhiQLGrammarParser.RULE_query_input);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 491;
...
function Standard_streamContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_standard_stream;
...
SiddhiQLGrammarParser.prototype.standard_stream = function() {

    var localctx = new Standard_streamContext(this, this._ctx, this.state);
    this.enterRule(localctx, 48, SiddhiQLGrammarParser.RULE_standard_stream);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 493; 
        ...
        this.state = 501;
        _la = this._input.LA(1);
        if(_la===SiddhiQLGrammarParser.OPEN_SQARE_BRACKETS || _la===SiddhiQLGrammarParser.HASH) {
            this.state = 500; 
...
function Join_streamContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_join_stream;
...
Join_streamContext.prototype.UNIDIRECTIONAL = function() {
    return this.getToken(SiddhiQLGrammarParser.UNIDIRECTIONAL, 0);
};

Join_streamContext.prototype.ON = function() {
    return this.getToken(SiddhiQLGrammarParser.ON, 0);
};
...
SiddhiQLGrammarParser.prototype.join_stream = function() {

    var localctx = new Join_streamContext(this, this._ctx, this.state);
    this.enterRule(localctx, 50, SiddhiQLGrammarParser.RULE_join_stream);
    var _la = 0; // Token type
    try {
        this.state = 535;
        ...
        case 1:
            ...
            this.state = 506;
            localctx.right_unidirectional = this.match(SiddhiQLGrammarParser.UNIDIRECTIONAL);
            this.state = 509;
            _la = this._input.LA(1);
            if(_la===SiddhiQLGrammarParser.ON) {
                this.state = 507;
                this.match(SiddhiQLGrammarParser.ON);
                this.state = 508; 
                this.expression();
            }
            ...
            this.state = 512;
            _la = this._input.LA(1);
            if(_la===SiddhiQLGrammarParser.WITHIN) {
                this.state = 511; 
                this.within_time();
            }
        ...
        case 3:
            ...
            localctx.left_source = this.join_source();
            this.state = 525;
            localctx.left_unidirectional = this.match(SiddhiQLGrammarParser.UNIDIRECTIONAL);
            this.state = 526; 
            this.join();
            this.state = 527; 
            localctx.right_source = this.join_source();
...
function Join_sourceContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_join_source;
    return this;
}
...
SiddhiQLGrammarParser.prototype.join_source = function() {

    var localctx = new Join_sourceContext(this, this._ctx, this.state);
    this.enterRule(localctx, 52, SiddhiQLGrammarParser.RULE_join_source);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 537; 
        ...
        this.state = 542;
        _la = this._input.LA(1);
        if(_la===SiddhiQLGrammarParser.HASH) {
            this.state = 541; 
            this.window();
        }
        ...
        this.state = 546;
        _la = this._input.LA(1);
        if(_la===SiddhiQLGrammarParser.AS) {
            this.state = 544;
            this.match(SiddhiQLGrammarParser.AS);
            this.state = 545; 
            this.stream_alias();
...
function Pattern_streamContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_pattern_stream;
    return this;
}
...
SiddhiQLGrammarParser.prototype.pattern_stream = function() {

    var localctx = new Pattern_streamContext(this, this._ctx, this.state);
    this.enterRule(localctx, 54, SiddhiQLGrammarParser.RULE_pattern_stream);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 548; 
...
function Every_pattern_source_chainContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_every_pattern_source_chain;
    return this;
}
...
Every_pattern_source_chainContext.prototype.EVERY = function() {
    return this.getToken(SiddhiQLGrammarParser.EVERY, 0);
};
...
SiddhiQLGrammarParser.prototype.every_pattern_source_chain = function(_p) {
	if(_p===undefined) {
	    _p = 0;
	}
    ...
    var _startState = 56;
    this.enterRecursionRule(localctx, 56, SiddhiQLGrammarParser.RULE_every_pattern_source_chain, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 570;
        ...
        case 2:
            this.state = 557;
            this.match(SiddhiQLGrammarParser.EVERY);
            this.state = 558;
            this.match(SiddhiQLGrammarParser.OPEN_PAR);
            this.state = 559; 
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                this.pushNewRecursionContext(localctx, _startState, SiddhiQLGrammarParser.RULE_every_pattern_source_chain);
                this.state = 572;
                if (!( this.precpred(this._ctx, 3))) {
                    throw new antlr4.error.FailedPredicateException(this, "this.precpred(this._ctx, 3)");
                }
                this.state = 573;
                this.match(SiddhiQLGrammarParser.FOLLOWED_BY);
                this.state = 574; 
...
function Pattern_source_chainContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_pattern_source_chain;
    return this;
}
...
SiddhiQLGrammarParser.prototype.pattern_source_chain = function(_p) {
	if(_p===undefined) {
	    _p = 0;
	}
    var _parentctx = this._ctx;
    ...
    var _prevctx = localctx;
    var _startState = 58;
    this.enterRecursionRule(localctx, 58, SiddhiQLGrammarParser.RULE_pattern_source_chain, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 591;
        switch(this._input.LA(1)) {
        case SiddhiQLGrammarParser.OPEN_PAR:
            this.state = 581;
            this.match(SiddhiQLGrammarParser.OPEN_PAR);
            this.state = 582; 
            this.pattern_source_chain(0);
            ...
            break;
        case SiddhiQLGrammarParser.HASH:
        case SiddhiQLGrammarParser.STREAM:
        case SiddhiQLGrammarParser.DEFINE:
        case SiddhiQLGrammarParser.TABLE:
        case SiddhiQLGrammarParser.FROM:
        case SiddhiQLGrammarParser.PARTITION:
        case SiddhiQLGrammarParser.WINDOW:
        case SiddhiQLGrammarParser.SELECT:
        case SiddhiQLGrammarParser.GROUP:
        case SiddhiQLGrammarParser.BY:
        case SiddhiQLGrammarParser.HAVING:
        case SiddhiQLGrammarParser.INSERT:
        case SiddhiQLGrammarParser.DELETE:
        case SiddhiQLGrammarParser.UPDATE:
        case SiddhiQLGrammarParser.RETURN:
        case SiddhiQLGrammarParser.EVENTS:
        case SiddhiQLGrammarParser.INTO:
        case SiddhiQLGrammarParser.OUTPUT:
        case SiddhiQLGrammarParser.EXPIRED:
        case SiddhiQLGrammarParser.CURRENT:
        case SiddhiQLGrammarParser.SNAPSHOT:
        case SiddhiQLGrammarParser.FOR:
        case SiddhiQLGrammarParser.RAW:
        case SiddhiQLGrammarParser.OF:
        case SiddhiQLGrammarParser.AS:
        case SiddhiQLGrammarParser.OR:
        case SiddhiQLGrammarParser.AND:
        case SiddhiQLGrammarParser.ON:
        case SiddhiQLGrammarParser.IS:
        case SiddhiQLGrammarParser.NOT:
        case SiddhiQLGrammarParser.WITHIN:
        case SiddhiQLGrammarParser.WITH:
        case SiddhiQLGrammarParser.BEGIN:
        case SiddhiQLGrammarParser.END:
        case SiddhiQLGrammarParser.NULL:
        case SiddhiQLGrammarParser.EVERY:
        case SiddhiQLGrammarParser.LAST:
        case SiddhiQLGrammarParser.ALL:
        case SiddhiQLGrammarParser.FIRST:
        case SiddhiQLGrammarParser.JOIN:
        case SiddhiQLGrammarParser.INNER:
        case SiddhiQLGrammarParser.OUTER:
        case SiddhiQLGrammarParser.RIGHT:
        case SiddhiQLGrammarParser.LEFT:
        case SiddhiQLGrammarParser.FULL:
        case SiddhiQLGrammarParser.UNIDIRECTIONAL:
        case SiddhiQLGrammarParser.YEARS:
        case SiddhiQLGrammarParser.MONTHS:
        case SiddhiQLGrammarParser.WEEKS:
        case SiddhiQLGrammarParser.DAYS:
        case SiddhiQLGrammarParser.HOURS:
        case SiddhiQLGrammarParser.MINUTES:
        case SiddhiQLGrammarParser.SECONDS:
        case SiddhiQLGrammarParser.MILLISECONDS:
        case SiddhiQLGrammarParser.FALSE:
        case SiddhiQLGrammarParser.TRUE:
        case SiddhiQLGrammarParser.STRING:
        case SiddhiQLGrammarParser.INT:
        case SiddhiQLGrammarParser.LONG:
        case SiddhiQLGrammarParser.FLOAT:
        case SiddhiQLGrammarParser.DOUBLE:
        case SiddhiQLGrammarParser.BOOL:
        case SiddhiQLGrammarParser.OBJECT:
        case SiddhiQLGrammarParser.ID_QUOTES:
        case SiddhiQLGrammarParser.ID:
            this.state = 587; 
            this.pattern_source();
            this.state = 589;
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                this.pushNewRecursionContext(localctx, _startState, SiddhiQLGrammarParser.RULE_pattern_source_chain);
                this.state = 593;
...
function Pattern_sourceContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_pattern_source;
    return this;
}
...
SiddhiQLGrammarParser.prototype.pattern_source = function() {

    var localctx = new Pattern_sourceContext(this, this._ctx, this.state);
    this.enterRule(localctx, 60, SiddhiQLGrammarParser.RULE_pattern_source);
    try {
        this.state = 604;
...
function Logical_stateful_sourceContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_logical_stateful_source;
    return this;
}
...
Logical_stateful_sourceContext.prototype.NOT = function() {
    return this.getToken(SiddhiQLGrammarParser.NOT, 0);
};
...
Logical_stateful_sourceContext.prototype.AND = function() {
    return this.getToken(SiddhiQLGrammarParser.AND, 0);
};

Logical_stateful_sourceContext.prototype.OR = function() {
    return this.getToken(SiddhiQLGrammarParser.OR, 0);
};
...
SiddhiQLGrammarParser.prototype.logical_stateful_source = function() {

    var localctx = new Logical_stateful_sourceContext(this, this._ctx, this.state);
    this.enterRule(localctx, 62, SiddhiQLGrammarParser.RULE_logical_stateful_source);
    try {
        this.state = 620;
        ...
        case 1:
            this.enterOuterAlt(localctx, 1);
            this.state = 606;
            this.match(SiddhiQLGrammarParser.NOT);
            this.state = 607; 
            this.standard_stateful_source();
            this.state = 610;
            ...
            if(la_===1) {
                this.state = 608;
                this.match(SiddhiQLGrammarParser.AND);
                this.state = 609; 
                this.standard_stateful_source();
...
function Pattern_collection_stateful_sourceContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_pattern_collection_stateful_source;
    return this;
}
...
SiddhiQLGrammarParser.prototype.pattern_collection_stateful_source = function() {

    var localctx = new Pattern_collection_stateful_sourceContext(this, this._ctx, this.state);
    this.enterRule(localctx, 64, SiddhiQLGrammarParser.RULE_pattern_collection_stateful_source);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 622; 
        this.standard_stateful_source();
        this.state = 623;
        this.match(SiddhiQLGrammarParser.LT);
        this.state = 624; 
        this.collect();
        this.state = 625;
        this.match(SiddhiQLGrammarParser.GT);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Standard_stateful_sourceContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_standard_stateful_source;
    return this;
}
...
SiddhiQLGrammarParser.prototype.standard_stateful_source = function() {

    var localctx = new Standard_stateful_sourceContext(this, this._ctx, this.state);
    this.enterRule(localctx, 66, SiddhiQLGrammarParser.RULE_standard_stateful_source);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 630;
...
function Basic_sourceContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_basic_source;
    return this;
}
...
SiddhiQLGrammarParser.prototype.basic_source = function() {

    var localctx = new Basic_sourceContext(this, this._ctx, this.state);
    this.enterRule(localctx, 68, SiddhiQLGrammarParser.RULE_basic_source);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 634; 
        this.source();
...
function Basic_source_stream_handlersContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_basic_source_stream_handlers;
    return this;
}
...
SiddhiQLGrammarParser.prototype.basic_source_stream_handlers = function() {

    var localctx = new Basic_source_stream_handlersContext(this, this._ctx, this.state);
    this.enterRule(localctx, 70, SiddhiQLGrammarParser.RULE_basic_source_stream_handlers);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 639; 
        this._errHandler.sync(this);
...
function Basic_source_stream_handlerContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_basic_source_stream_handler;
    return this;
}
...
SiddhiQLGrammarParser.prototype.basic_source_stream_handler = function() {

    var localctx = new Basic_source_stream_handlerContext(this, this._ctx, this.state);
    this.enterRule(localctx, 72, SiddhiQLGrammarParser.RULE_basic_source_stream_handler);
    try {
        this.state = 645;
...
function Sequence_streamContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_sequence_stream;
    return this;
}
...
SiddhiQLGrammarParser.prototype.sequence_stream = function() {

    var localctx = new Sequence_streamContext(this, this._ctx, this.state);
    this.enterRule(localctx, 74, SiddhiQLGrammarParser.RULE_sequence_stream);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 648;
...
function Sequence_source_chainContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_sequence_source_chain;
    return this;
}
...
SiddhiQLGrammarParser.prototype.sequence_source_chain = function(_p) {
	if(_p===undefined) {
	    _p = 0;
	}
    var _parentctx = this._ctx;
    ...
    var _prevctx = localctx;
    var _startState = 76;
    this.enterRecursionRule(localctx, 76, SiddhiQLGrammarParser.RULE_sequence_source_chain, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 668;
        switch(this._input.LA(1)) {
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                this.pushNewRecursionContext(localctx, _startState, SiddhiQLGrammarParser.RULE_sequence_source_chain);
                this.state = 670;
                if (!( this.precpred(this._ctx, 2))) {
                    throw new antlr4.error.FailedPredicateException(this, "this.precpred(this._ctx, 2)");
                }
...
function Sequence_sourceContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_sequence_source;
    return this;
}
...
SiddhiQLGrammarParser.prototype.sequence_source = function() {

    var localctx = new Sequence_sourceContext(this, this._ctx, this.state);
    this.enterRule(localctx, 78, SiddhiQLGrammarParser.RULE_sequence_source);
    try {
        this.state = 681;
...
function Sequence_collection_stateful_sourceContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_sequence_collection_stateful_source;
...
SiddhiQLGrammarParser.prototype.sequence_collection_stateful_source = function() {

    var localctx = new Sequence_collection_stateful_sourceContext(this, this._ctx, this.state);
    this.enterRule(localctx, 80, SiddhiQLGrammarParser.RULE_sequence_collection_stateful_source);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 683; 
        this.standard_stateful_source();
        ...
        case SiddhiQLGrammarParser.LT:
            ...
            this.match(SiddhiQLGrammarParser.GT);
            break;
        case SiddhiQLGrammarParser.STAR:
            this.state = 688;
            localctx.zero_or_more = this.match(SiddhiQLGrammarParser.STAR);
            break;
        case SiddhiQLGrammarParser.QUESTION:
            this.state = 689;
            localctx.zero_or_one = this.match(SiddhiQLGrammarParser.QUESTION);
            break;
        case SiddhiQLGrammarParser.PLUS:
            this.state = 690;
            localctx.one_or_more = this.match(SiddhiQLGrammarParser.PLUS);
            break;
        default:
            throw new antlr4.error.NoViableAltException(this);
        }
...
function Anonymous_streamContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_anonymous_stream;
    return this;
}
...
SiddhiQLGrammarParser.prototype.anonymous_stream = function() {

    var localctx = new Anonymous_streamContext(this, this._ctx, this.state);
    this.enterRule(localctx, 82, SiddhiQLGrammarParser.RULE_anonymous_stream);
    var _la = 0; // Token type
    try {
        this.state = 709;
        switch(this._input.LA(1)) {
        ...
        case SiddhiQLGrammarParser.FROM:
            ...
            this.state = 707;
            _la = this._input.LA(1);
            if(((((_la - 45)) & ~0x1f) == 0 && ((1 << (_la - 45)) & ((1 << (SiddhiQLGrammarParser.EVENTS - 45)) | (1 << (SiddhiQLGrammarParser.EXPIRED - 45)) | (1 << (SiddhiQLGrammarParser.CURRENT - 45)) | (1 << (SiddhiQLGrammarParser.ALL - 45)))) !== 0)) {
                this.state = 706; 
...
function FilterContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_filter;
    return this;
}
...
SiddhiQLGrammarParser.prototype.filter = function() {

    var localctx = new FilterContext(this, this._ctx, this.state);
    this.enterRule(localctx, 84, SiddhiQLGrammarParser.RULE_filter);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 712;
        ...
        if(_la===SiddhiQLGrammarParser.HASH) {
            this.state = 711;
            this.match(SiddhiQLGrammarParser.HASH);
        }
...
function Stream_functionContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_stream_function;
    return this;
}
...
SiddhiQLGrammarParser.prototype.stream_function = function() {

    var localctx = new Stream_functionContext(this, this._ctx, this.state);
    this.enterRule(localctx, 86, SiddhiQLGrammarParser.RULE_stream_function);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 718;
        this.match(SiddhiQLGrammarParser.HASH);
...
function WindowContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_window;
    return this;
}
...
WindowContext.prototype.WINDOW = function() {
    return this.getToken(SiddhiQLGrammarParser.WINDOW, 0);
};
...
SiddhiQLGrammarParser.prototype.window = function() {

    var localctx = new WindowContext(this, this._ctx, this.state);
    this.enterRule(localctx, 88, SiddhiQLGrammarParser.RULE_window);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 721;
        this.match(SiddhiQLGrammarParser.HASH);
        this.state = 722;
        this.match(SiddhiQLGrammarParser.WINDOW);
        this.state = 723;
        this.match(SiddhiQLGrammarParser.DOT);
        this.state = 724; 
        this.function_operation();
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
...
function Query_sectionContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_query_section;
    return this;
}
...
Query_sectionContext.prototype.SELECT = function() {
    return this.getToken(SiddhiQLGrammarParser.SELECT, 0);
};
...
SiddhiQLGrammarParser.prototype.query_section = function() {

    var localctx = new Query_sectionContext(this, this._ctx, this.state);
    this.enterRule(localctx, 90, SiddhiQLGrammarParser.RULE_query_section);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 726;
        this.match(SiddhiQLGrammarParser.SELECT);
        this.state = 736;
        switch(this._input.LA(1)) {
        case SiddhiQLGrammarParser.STAR:
            this.state = 727;
            this.match(SiddhiQLGrammarParser.STAR);
            break;
        case SiddhiQLGrammarParser.INT_LITERAL:
        case SiddhiQLGrammarParser.LONG_LITERAL:
        case SiddhiQLGrammarParser.FLOAT_LITERAL:
        case SiddhiQLGrammarParser.DOUBLE_LITERAL:
        case SiddhiQLGrammarParser.OPEN_PAR:
        case SiddhiQLGrammarParser.PLUS:
        case SiddhiQLGrammarParser.MINUS:
        case SiddhiQLGrammarParser.HASH:
        case SiddhiQLGrammarParser.STREAM:
        case SiddhiQLGrammarParser.DEFINE:
        case SiddhiQLGrammarParser.TABLE:
        ...
        case SiddhiQLGrammarParser.ID_QUOTES:
        case SiddhiQLGrammarParser.ID:
        case SiddhiQLGrammarParser.STRING_LITERAL:
            this.state = 728; 
        ...
        this.state = 739;
        _la = this._input.LA(1);
        if(_la===SiddhiQLGrammarParser.GROUP) {
            this.state = 738; 
            this.group_by();
        }
        ...
        this.state = 742;
        _la = this._input.LA(1);
        if(_la===SiddhiQLGrammarParser.HAVING) {
            this.state = 741; 
            this.having();
        }
...
function Group_byContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_group_by;
    return this;
}
...
Group_byContext.prototype.GROUP = function() {
    return this.getToken(SiddhiQLGrammarParser.GROUP, 0);
};

Group_byContext.prototype.BY = function() {
    return this.getToken(SiddhiQLGrammarParser.BY, 0);
};
...
SiddhiQLGrammarParser.prototype.group_by = function() {

    var localctx = new Group_byContext(this, this._ctx, this.state);
    this.enterRule(localctx, 92, SiddhiQLGrammarParser.RULE_group_by);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 744;
        this.match(SiddhiQLGrammarParser.GROUP);
        this.state = 745;
        this.match(SiddhiQLGrammarParser.BY);
        this.state = 747; 
        this._errHandler.sync(this);
        var _alt = 1;
        do {
...
function HavingContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_having;
    return this;
}
...
HavingContext.prototype.HAVING = function() {
    return this.getToken(SiddhiQLGrammarParser.HAVING, 0);
};
...
SiddhiQLGrammarParser.prototype.having = function() {

    var localctx = new HavingContext(this, this._ctx, this.state);
    this.enterRule(localctx, 94, SiddhiQLGrammarParser.RULE_having);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 751;
        this.match(SiddhiQLGrammarParser.HAVING);
        this.state = 752; 
        this.expression();
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
...
function Query_outputContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_query_output;
    return this;
}
...
Query_outputContext.prototype.INSERT = function() {
    return this.getToken(SiddhiQLGrammarParser.INSERT, 0);
};

Query_outputContext.prototype.INTO = function() {
    return this.getToken(SiddhiQLGrammarParser.INTO, 0);
};
...
Query_outputContext.prototype.DELETE = function() {
    return this.getToken(SiddhiQLGrammarParser.DELETE, 0);
};
...
Query_outputContext.prototype.FOR = function() {
    return this.getToken(SiddhiQLGrammarParser.FOR, 0);
};

Query_outputContext.prototype.UPDATE = function() {
    return this.getToken(SiddhiQLGrammarParser.UPDATE, 0);
};
...
SiddhiQLGrammarParser.prototype.query_output = function() {

    var localctx = new Query_outputContext(this, this._ctx, this.state);
    this.enterRule(localctx, 96, SiddhiQLGrammarParser.RULE_query_output);
    var _la = 0; // Token type
    try {
        this.state = 782;
        switch(this._input.LA(1)) {
        case SiddhiQLGrammarParser.INSERT:
            this.enterOuterAlt(localctx, 1);
            this.state = 754;
            this.match(SiddhiQLGrammarParser.INSERT);
            this.state = 756;
            _la = this._input.LA(1);
            if(((((_la - 45)) & ~0x1f) == 0 && ((1 << (_la - 45)) & ((1 << (SiddhiQLGrammarParser.EVENTS - 45)) | (1 << (SiddhiQLGrammarParser.EXPIRED - 45)) | (1 << (SiddhiQLGrammarParser.CURRENT - 45)) | (1 << (SiddhiQLGrammarParser.ALL - 45)))) !== 0)) {
                this.state = 755; 
            ...
            this.state = 758;
            this.match(SiddhiQLGrammarParser.INTO);
            this.state = 759; 
            this.target();
            break;
        case SiddhiQLGrammarParser.DELETE:
            this.enterOuterAlt(localctx, 2);
            this.state = 760;
            this.match(SiddhiQLGrammarParser.DELETE);
            this.state = 761; 
            this.target();
            this.state = 764;
            _la = this._input.LA(1);
            if(_la===SiddhiQLGrammarParser.FOR) {
                this.state = 762;
                this.match(SiddhiQLGrammarParser.FOR);
                this.state = 763; 
                this.output_event_type();
            }
        ...
        case SiddhiQLGrammarParser.UPDATE:
            this.enterOuterAlt(localctx, 3);
            this.state = 769;
            this.match(SiddhiQLGrammarParser.UPDATE);
            this.state = 770; 
            this.target();
            this.state = 773;
            _la = this._input.LA(1);
...
function Output_event_typeContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_output_event_type;
    return this;
}
...
Output_event_typeContext.prototype.ALL = function() {
    return this.getToken(SiddhiQLGrammarParser.ALL, 0);
};

Output_event_typeContext.prototype.EVENTS = function() {
    return this.getToken(SiddhiQLGrammarParser.EVENTS, 0);
};

Output_event_typeContext.prototype.RAW = function() {
    return this.getToken(SiddhiQLGrammarParser.RAW, 0);
};

Output_event_typeContext.prototype.EXPIRED = function() {
    return this.getToken(SiddhiQLGrammarParser.EXPIRED, 0);
};

Output_event_typeContext.prototype.CURRENT = function() {
    return this.getToken(SiddhiQLGrammarParser.CURRENT, 0);
};
...
SiddhiQLGrammarParser.prototype.output_event_type = function() {

    var localctx = new Output_event_typeContext(this, this._ctx, this.state);
    this.enterRule(localctx, 98, SiddhiQLGrammarParser.RULE_output_event_type);
    var _la = 0; // Token type
    try {
        this.state = 798;
        ...
        case 1:
            this.enterOuterAlt(localctx, 1);
            this.state = 784;
            this.match(SiddhiQLGrammarParser.ALL);
            this.state = 785;
            this.match(SiddhiQLGrammarParser.EVENTS);
            break;
        ...
        case 2:
            ...
            this.match(SiddhiQLGrammarParser.ALL);
            this.state = 787;
            this.match(SiddhiQLGrammarParser.RAW);
            this.state = 788;
            this.match(SiddhiQLGrammarParser.EVENTS);
            break;
        ...
        case 3:
            this.enterOuterAlt(localctx, 3);
            this.state = 789;
            this.match(SiddhiQLGrammarParser.EXPIRED);
            this.state = 790;
            this.match(SiddhiQLGrammarParser.EVENTS);
            break;
        ...
        case 5:
            ...
            this.state = 795;
            _la = this._input.LA(1);
            if(_la===SiddhiQLGrammarParser.CURRENT) {
                this.state = 794;
                this.match(SiddhiQLGrammarParser.CURRENT);
            }
...
function Output_rateContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_output_rate;
    return this;
}
...
Output_rateContext.prototype.OUTPUT = function() {
    return this.getToken(SiddhiQLGrammarParser.OUTPUT, 0);
};
...
Output_rateContext.prototype.INT_LITERAL = function() {
    return this.getToken(SiddhiQLGrammarParser.INT_LITERAL, 0);
};
...
Output_rateContext.prototype.SNAPSHOT = function() {
    return this.getToken(SiddhiQLGrammarParser.SNAPSHOT, 0);
};
...
SiddhiQLGrammarParser.prototype.output_rate = function() {

    var localctx = new Output_rateContext(this, this._ctx, this.state);
    this.enterRule(localctx, 100, SiddhiQLGrammarParser.RULE_output_rate);
    var _la = 0; // Token type
    try {
        this.state = 814;
        ...
        case 1:
            this.enterOuterAlt(localctx, 1);
            this.state = 800;
            this.match(SiddhiQLGrammarParser.OUTPUT);
            this.state = 802;
            _la = this._input.LA(1);
            if(((((_la - 67)) & ~0x1f) == 0 && ((1 << (_la - 67)) & ((1 << (SiddhiQLGrammarParser.LAST - 67)) | (1 << (SiddhiQLGrammarParser.ALL - 67)) | (1 << (SiddhiQLGrammarParser.FIRST - 67)))) !== 0)) {
                this.state = 801; 
            ...
            case 2:
                this.state = 806;
                this.match(SiddhiQLGrammarParser.INT_LITERAL);
                this.state = 807;
                this.match(SiddhiQLGrammarParser.EVENTS);
                break;
        ...
        case 2:
            ...
            this.match(SiddhiQLGrammarParser.OUTPUT);
            this.state = 811;
            this.match(SiddhiQLGrammarParser.SNAPSHOT);
            this.state = 812;
            this.match(SiddhiQLGrammarParser.EVERY);
            this.state = 813; 
            this.time_value();
...
function Output_rate_typeContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_output_rate_type;
    return this;
}
...
Output_rate_typeContext.prototype.LAST = function() {
    return this.getToken(SiddhiQLGrammarParser.LAST, 0);
};

Output_rate_typeContext.prototype.FIRST = function() {
    return this.getToken(SiddhiQLGrammarParser.FIRST, 0);
};
...
SiddhiQLGrammarParser.prototype.output_rate_type = function() {

    var localctx = new Output_rate_typeContext(this, this._ctx, this.state);
    this.enterRule(localctx, 102, SiddhiQLGrammarParser.RULE_output_rate_type);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 816;
...
function Within_timeContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_within_time;
    return this;
}
...
Within_timeContext.prototype.WITHIN = function() {
    return this.getToken(SiddhiQLGrammarParser.WITHIN, 0);
};
...
SiddhiQLGrammarParser.prototype.within_time = function() {

    var localctx = new Within_timeContext(this, this._ctx, this.state);
    this.enterRule(localctx, 104, SiddhiQLGrammarParser.RULE_within_time);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 818;
        this.match(SiddhiQLGrammarParser.WITHIN);
        this.state = 819; 
        this.time_value();
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
...
function Output_attributeContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_output_attribute;
    return this;
}
...
SiddhiQLGrammarParser.prototype.output_attribute = function() {

    var localctx = new Output_attributeContext(this, this._ctx, this.state);
    this.enterRule(localctx, 106, SiddhiQLGrammarParser.RULE_output_attribute);
    try {
        this.state = 826;
...
function AttributeContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_attribute;
    return this;
}
...
SiddhiQLGrammarParser.prototype.attribute = function() {

    var localctx = new AttributeContext(this, this._ctx, this.state);
    this.enterRule(localctx, 108, SiddhiQLGrammarParser.RULE_attribute);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 828; 
...
function ExpressionContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_expression;
    return this;
}
...
SiddhiQLGrammarParser.prototype.expression = function() {

    var localctx = new ExpressionContext(this, this._ctx, this.state);
    this.enterRule(localctx, 110, SiddhiQLGrammarParser.RULE_expression);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 830; 
        this.math_operation(0);
...
function Math_operationContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_math_operation;
    return this;
}
...
In_math_operationContext.prototype.IN = function() {
    return this.getToken(SiddhiQLGrammarParser.IN, 0);
};
...
SiddhiQLGrammarParser.prototype.math_operation = function(_p) {
	if(_p===undefined) {
	    _p = 0;
	}
    var _parentctx = this._ctx;
    ...
    var _prevctx = localctx;
    var _startState = 112;
    this.enterRecursionRule(localctx, 112, SiddhiQLGrammarParser.RULE_math_operation, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 843;
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case 1:
                    ...
                    this.pushNewRecursionContext(localctx, _startState, SiddhiQLGrammarParser.RULE_math_operation);
                    this.state = 845;
                    ...
                    case SiddhiQLGrammarParser.STAR:
                        this.state = 846;
                        localctx.multiply = this.match(SiddhiQLGrammarParser.STAR);
                        break;
                    case SiddhiQLGrammarParser.DIV:
                        this.state = 847;
                        localctx.devide = this.match(SiddhiQLGrammarParser.DIV);
                        break;
                    case SiddhiQLGrammarParser.MOD:
                        this.state = 848;
                        localctx.mod = this.match(SiddhiQLGrammarParser.MOD);
                        break;
                    default:
                        throw new antlr4.error.NoViableAltException(this);
                    }
                ...
                case 2:
                    ...
                    case SiddhiQLGrammarParser.PLUS:
                        this.state = 853;
                        localctx.add = this.match(SiddhiQLGrammarParser.PLUS);
                        break;
                    case SiddhiQLGrammarParser.MINUS:
                        this.state = 854;
                        localctx.substract = this.match(SiddhiQLGrammarParser.MINUS);
                        break;
                    default:
                        throw new antlr4.error.NoViableAltException(this);
                    }
                ...
                case 3:
                    ...
                    this.state = 863;
                    switch(this._input.LA(1)) {
                    case SiddhiQLGrammarParser.GT_EQ:
                        this.state = 859;
                        localctx.gt_eq = this.match(SiddhiQLGrammarParser.GT_EQ);
                        break;
                    case SiddhiQLGrammarParser.LT_EQ:
                        this.state = 860;
                        localctx.lt_eq = this.match(SiddhiQLGrammarParser.LT_EQ);
                        break;
                    case SiddhiQLGrammarParser.GT:
                        this.state = 861;
                        localctx.gt = this.match(SiddhiQLGrammarParser.GT);
                        break;
                    case SiddhiQLGrammarParser.LT:
                        this.state = 862;
                        localctx.lt = this.match(SiddhiQLGrammarParser.LT);
                        break;
                    default:
                        throw new antlr4.error.NoViableAltException(this);
                    }
                ...
                case 4:
                    ...
                    this.state = 869;
                    switch(this._input.LA(1)) {
                    case SiddhiQLGrammarParser.EQ:
                        this.state = 867;
                        localctx.eq = this.match(SiddhiQLGrammarParser.EQ);
                        break;
                    case SiddhiQLGrammarParser.NOT_EQ:
                        this.state = 868;
                        localctx.not_eq = this.match(SiddhiQLGrammarParser.NOT_EQ);
                        break;
                    default:
                        throw new antlr4.error.NoViableAltException(this);
                    }
                ...
                case 7:
                    ...
                    this.state = 879;
                    this.match(SiddhiQLGrammarParser.IN);
                    this.state = 880; 
                    this.name();
                    break;
...
function Function_operationContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_function_operation;
    return this;
}
...
SiddhiQLGrammarParser.prototype.function_operation = function() {

    var localctx = new Function_operationContext(this, this._ctx, this.state);
    this.enterRule(localctx, 114, SiddhiQLGrammarParser.RULE_function_operation);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 889;
        ...
        this.state = 894;
        _la = this._input.LA(1);
        if(((((_la - 1)) & ~0x1f) == 0 && ((1 << (_la - 1)) & ((1 << (SiddhiQLGrammarParser.INT_LITERAL - 1)) | (1 << (SiddhiQLGrammarParser.LONG_LITERAL - 1)) | (1 << (SiddhiQLGrammarParser.FLOAT_LITERAL - 1)) | (1 << (SiddhiQLGrammarParser.DOUBLE_LITERAL - 1)) | (1 << (SiddhiQLGrammarParser.OPEN_PAR - 1)) | (1 << (SiddhiQLGrammarParser.PLUS - 1)) | (1 << (SiddhiQLGrammarParser.MINUS - 1)) | (1 << (SiddhiQLGrammarParser.HASH - 1)) | (1 << (SiddhiQLGrammarParser.STREAM - 1)) | (1 << (SiddhiQLGrammarParser.DEFINE - 1)) | (1 << (SiddhiQLGrammarParser.TABLE - 1)))) !== 0) || ((((_la - 34)) & ~0x1f) == 0 && ((1 << (_la - 34)) & ((1 << (SiddhiQLGrammarParser.FROM - 34)) | (1 << (SiddhiQLGrammarParser.PARTITION - 34)) | (1 << (SiddhiQLGrammarParser.WINDOW - 34)) | (1 << (SiddhiQLGrammarParser.SELECT - 34)) | (1 << (SiddhiQLGrammarParser.GROUP - 34)) | (1 << (SiddhiQLGrammarParser.BY - 34)) | (1 << (SiddhiQLGrammarParser.HAVING - 34)) | (1 << (SiddhiQLGrammarParser.INSERT - 34)) | (1 << (SiddhiQLGrammarParser.DELETE - 34)) | (1 << (SiddhiQLGrammarParser.UPDATE - 34)) | (1 << (SiddhiQLGrammarParser.RETURN - 34)) | (1 << (SiddhiQLGrammarParser.EVENTS - 34)) | (1 << (SiddhiQLGrammarParser.INTO - 34)) | (1 << (SiddhiQLGrammarParser.OUTPUT - 34)) | (1 << (SiddhiQLGrammarParser.EXPIRED - 34)) | (1 << (SiddhiQLGrammarParser.CURRENT - 34)) | (1 << (SiddhiQLGrammarParser.SNAPSHOT - 34)) | (1 << (SiddhiQLGrammarParser.FOR - 34)) | (1 << (SiddhiQLGrammarParser.RAW - 34)) | (1 << (SiddhiQLGrammarParser.OF - 34)) | (1 << (SiddhiQLGrammarParser.AS - 34)) | (1 << (SiddhiQLGrammarParser.OR - 34)) | (1 << (SiddhiQLGrammarParser.AND - 34)) | (1 << (SiddhiQLGrammarParser.ON - 34)) | (1 << (SiddhiQLGrammarParser.IS - 34)) | (1 << (SiddhiQLGrammarParser.NOT - 34)) | (1 << (SiddhiQLGrammarParser.WITHIN - 34)) | (1 << (SiddhiQLGrammarParser.WITH - 34)) | (1 << (SiddhiQLGrammarParser.BEGIN - 34)) | (1 << (SiddhiQLGrammarParser.END - 34)) | (1 << (SiddhiQLGrammarParser.NULL - 34)))) !== 0) || ((((_la - 66)) & ~0x1f) == 0 && ((1 << (_la - 66)) & ((1 << (SiddhiQLGrammarParser.EVERY - 66)) | (1 << (SiddhiQLGrammarParser.LAST - 66)) | (1 << (SiddhiQLGrammarParser.ALL - 66)) | (1 << (SiddhiQLGrammarParser.FIRST - 66)) | (1 << (SiddhiQLGrammarParser.JOIN - 66)) | (1 << (SiddhiQLGrammarParser.INNER - 66)) | (1 << (SiddhiQLGrammarParser.OUTER - 66)) | (1 << (SiddhiQLGrammarParser.RIGHT - 66)) | (1 << (SiddhiQLGrammarParser.LEFT - 66)) | (1 << (SiddhiQLGrammarParser.FULL - 66)) | (1 << (SiddhiQLGrammarParser.UNIDIRECTIONAL - 66)) | (1 << (SiddhiQLGrammarParser.YEARS - 66)) | (1 << (SiddhiQLGrammarParser.MONTHS - 66)) | (1 << (SiddhiQLGrammarParser.WEEKS - 66)) | (1 << (SiddhiQLGrammarParser.DAYS - 66)) | (1 << (SiddhiQLGrammarParser.HOURS - 66)) | (1 << (SiddhiQLGrammarParser.MINUTES - 66)) | (1 << (SiddhiQLGrammarParser.SECONDS - 66)) | (1 << (SiddhiQLGrammarParser.MILLISECONDS - 66)) | (1 << (SiddhiQLGrammarParser.FALSE - 66)) | (1 << (SiddhiQLGrammarParser.TRUE - 66)) | (1 << (SiddhiQLGrammarParser.STRING - 66)) | (1 << (SiddhiQLGrammarParser.INT - 66)) | (1 << (SiddhiQLGrammarParser.LONG - 66)) | (1 << (SiddhiQLGrammarParser.FLOAT - 66)) | (1 << (SiddhiQLGrammarParser.DOUBLE - 66)) | (1 << (SiddhiQLGrammarParser.BOOL - 66)) | (1 << (SiddhiQLGrammarParser.OBJECT - 66)) | (1 << (SiddhiQLGrammarParser.ID_QUOTES - 66)) | (1 << (SiddhiQLGrammarParser.ID - 66)) | (1 << (SiddhiQLGrammarParser.STRING_LITERAL - 66)))) !== 0)) {
            this.state = 893; 
            this.attribute_list();
        }
...
function Attribute_listContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_attribute_list;
    return this;
}
...
SiddhiQLGrammarParser.prototype.attribute_list = function() {

    var localctx = new Attribute_listContext(this, this._ctx, this.state);
    this.enterRule(localctx, 116, SiddhiQLGrammarParser.RULE_attribute_list);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 898; 
...
function Null_checkContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_null_check;
    return this;
}
...
Null_checkContext.prototype.IS = function() {
    return this.getToken(SiddhiQLGrammarParser.IS, 0);
};

Null_checkContext.prototype.NULL = function() {
    return this.getToken(SiddhiQLGrammarParser.NULL, 0);
};
...
SiddhiQLGrammarParser.prototype.null_check = function() {

    var localctx = new Null_checkContext(this, this._ctx, this.state);
    this.enterRule(localctx, 118, SiddhiQLGrammarParser.RULE_null_check);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 908;
        ...
        this.state = 910;
        this.match(SiddhiQLGrammarParser.IS);
        this.state = 911;
        this.match(SiddhiQLGrammarParser.NULL);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Stream_referenceContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_stream_reference;
...
SiddhiQLGrammarParser.prototype.stream_reference = function() {

    var localctx = new Stream_referenceContext(this, this._ctx, this.state);
    this.enterRule(localctx, 120, SiddhiQLGrammarParser.RULE_stream_reference);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 914;
        ...
        if(_la===SiddhiQLGrammarParser.HASH) {
            this.state = 913;
            localctx.hash = this.match(SiddhiQLGrammarParser.HASH);
        }
        ...
        this.state = 921;
        _la = this._input.LA(1);
        if(_la===SiddhiQLGrammarParser.OPEN_SQARE_BRACKETS) {
            this.state = 917;
            this.match(SiddhiQLGrammarParser.OPEN_SQARE_BRACKETS);
            this.state = 918; 
...
function Attribute_referenceContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_attribute_reference;
...
SiddhiQLGrammarParser.prototype.attribute_reference = function() {

    var localctx = new Attribute_referenceContext(this, this._ctx, this.state);
    this.enterRule(localctx, 122, SiddhiQLGrammarParser.RULE_attribute_reference);
    var _la = 0; // Token type
    try {
        this.state = 947;
        ...
        case 1:
            ...
            if(_la===SiddhiQLGrammarParser.HASH) {
                this.state = 923;
                localctx.hash1 = this.match(SiddhiQLGrammarParser.HASH);
            }
            ...
            if(_la===SiddhiQLGrammarParser.HASH) {
                this.state = 933;
                localctx.hash2 = this.match(SiddhiQLGrammarParser.HASH);
                this.state = 934; 
...
function Attribute_indexContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_attribute_index;
    return this;
}
...
SiddhiQLGrammarParser.prototype.attribute_index = function() {

    var localctx = new Attribute_indexContext(this, this._ctx, this.state);
    this.enterRule(localctx, 124, SiddhiQLGrammarParser.RULE_attribute_index);
    var _la = 0; // Token type
    try {
        this.state = 955;
        switch(this._input.LA(1)) {
        ...
        case SiddhiQLGrammarParser.LAST:
            this.enterOuterAlt(localctx, 2);
            this.state = 950;
            this.match(SiddhiQLGrammarParser.LAST);
            this.state = 953;
            _la = this._input.LA(1);
            if(_la===SiddhiQLGrammarParser.MINUS) {
                this.state = 951;
                this.match(SiddhiQLGrammarParser.MINUS);
                this.state = 952;
                this.match(SiddhiQLGrammarParser.INT_LITERAL);
            }
...
function Function_idContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_function_id;
    return this;
}
...
SiddhiQLGrammarParser.prototype.function_id = function() {

    var localctx = new Function_idContext(this, this._ctx, this.state);
    this.enterRule(localctx, 126, SiddhiQLGrammarParser.RULE_function_id);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 957; 
        this.name();
...
function Function_namespaceContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_function_namespace;
    return this;
}
...
SiddhiQLGrammarParser.prototype.function_namespace = function() {

    var localctx = new Function_namespaceContext(this, this._ctx, this.state);
    this.enterRule(localctx, 128, SiddhiQLGrammarParser.RULE_function_namespace);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 959; 
        this.name();
...
function Stream_idContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_stream_id;
    return this;
}
...
SiddhiQLGrammarParser.prototype.stream_id = function() {

    var localctx = new Stream_idContext(this, this._ctx, this.state);
    this.enterRule(localctx, 130, SiddhiQLGrammarParser.RULE_stream_id);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 961; 
        this.name();
...
function Stream_aliasContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_stream_alias;
    return this;
}
...
SiddhiQLGrammarParser.prototype.stream_alias = function() {

    var localctx = new Stream_aliasContext(this, this._ctx, this.state);
    this.enterRule(localctx, 132, SiddhiQLGrammarParser.RULE_stream_alias);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 963; 
        this.name();
...
function Property_nameContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_property_name;
    return this;
}
...
SiddhiQLGrammarParser.prototype.property_name = function() {

    var localctx = new Property_nameContext(this, this._ctx, this.state);
    this.enterRule(localctx, 134, SiddhiQLGrammarParser.RULE_property_name);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 965; 
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(_la===SiddhiQLGrammarParser.DOT) {
            this.state = 966;
            this.match(SiddhiQLGrammarParser.DOT);
            this.state = 967; 
            this.name();
...
function Attribute_nameContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_attribute_name;
    return this;
}
...
SiddhiQLGrammarParser.prototype.attribute_name = function() {

    var localctx = new Attribute_nameContext(this, this._ctx, this.state);
    this.enterRule(localctx, 136, SiddhiQLGrammarParser.RULE_attribute_name);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 973; 
        this.name();
...
function Property_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_property_value;
    return this;
}
...
SiddhiQLGrammarParser.prototype.property_value = function() {

    var localctx = new Property_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 138, SiddhiQLGrammarParser.RULE_property_value);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 975; 
        this.string_value();
...
function SourceContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_source;
...
SiddhiQLGrammarParser.prototype.source = function() {

    var localctx = new SourceContext(this, this._ctx, this.state);
    this.enterRule(localctx, 140, SiddhiQLGrammarParser.RULE_source);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 978;
        ...
        if(_la===SiddhiQLGrammarParser.HASH) {
            this.state = 977;
            localctx.inner = this.match(SiddhiQLGrammarParser.HASH);
        }
...
function TargetContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_target;
    return this;
}
...
SiddhiQLGrammarParser.prototype.target = function() {

    var localctx = new TargetContext(this, this._ctx, this.state);
    this.enterRule(localctx, 142, SiddhiQLGrammarParser.RULE_target);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 982; 
        this.source();
...
function EventContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_event;
    return this;
}
...
SiddhiQLGrammarParser.prototype.event = function() {

    var localctx = new EventContext(this, this._ctx, this.state);
    this.enterRule(localctx, 144, SiddhiQLGrammarParser.RULE_event);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 984; 
        this.name();
...
function NameContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_name;
    return this;
}
...
SiddhiQLGrammarParser.prototype.name = function() {

    var localctx = new NameContext(this, this._ctx, this.state);
    this.enterRule(localctx, 146, SiddhiQLGrammarParser.RULE_name);
    try {
        this.state = 988;
        switch(this._input.LA(1)) {
        case SiddhiQLGrammarParser.ID_QUOTES:
...
function CollectContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_collect;
...
CollectContext.prototype.INT_LITERAL = function(i) {
    ...
    if(i===null) {
        return this.getTokens(SiddhiQLGrammarParser.INT_LITERAL);
    } else {
        return this.getToken(SiddhiQLGrammarParser.INT_LITERAL, i);
    }
};
...
SiddhiQLGrammarParser.prototype.collect = function() {

    var localctx = new CollectContext(this, this._ctx, this.state);
    this.enterRule(localctx, 148, SiddhiQLGrammarParser.RULE_collect);
    try {
        this.state = 998;
        ...
        case 1:
            this.enterOuterAlt(localctx, 1);
            this.state = 990;
            localctx.start = this.match(SiddhiQLGrammarParser.INT_LITERAL);
            this.state = 991;
            this.match(SiddhiQLGrammarParser.COL);
            this.state = 992;
            localctx.end = this.match(SiddhiQLGrammarParser.INT_LITERAL);
            break;
...
function Attribute_typeContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_attribute_type;
    return this;
}
...
Attribute_typeContext.prototype.STRING = function() {
    return this.getToken(SiddhiQLGrammarParser.STRING, 0);
};

Attribute_typeContext.prototype.INT = function() {
    return this.getToken(SiddhiQLGrammarParser.INT, 0);
};

Attribute_typeContext.prototype.LONG = function() {
    return this.getToken(SiddhiQLGrammarParser.LONG, 0);
};

Attribute_typeContext.prototype.FLOAT = function() {
    return this.getToken(SiddhiQLGrammarParser.FLOAT, 0);
};

Attribute_typeContext.prototype.DOUBLE = function() {
    return this.getToken(SiddhiQLGrammarParser.DOUBLE, 0);
};

Attribute_typeContext.prototype.BOOL = function() {
    return this.getToken(SiddhiQLGrammarParser.BOOL, 0);
};

Attribute_typeContext.prototype.OBJECT = function() {
    return this.getToken(SiddhiQLGrammarParser.OBJECT, 0);
};
...
SiddhiQLGrammarParser.prototype.attribute_type = function() {

    var localctx = new Attribute_typeContext(this, this._ctx, this.state);
    this.enterRule(localctx, 150, SiddhiQLGrammarParser.RULE_attribute_type);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1000;
        _la = this._input.LA(1);
        if(!(((((_la - 87)) & ~0x1f) == 0 && ((1 << (_la - 87)) & ((1 << (SiddhiQLGrammarParser.STRING - 87)) | (1 << (SiddhiQLGrammarParser.INT - 87)) | (1 << (SiddhiQLGrammarParser.LONG - 87)) | (1 << (SiddhiQLGrammarParser.FLOAT - 87)) | (1 << (SiddhiQLGrammarParser.DOUBLE - 87)) | (1 << (SiddhiQLGrammarParser.BOOL - 87)) | (1 << (SiddhiQLGrammarParser.OBJECT - 87)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        this.consume();
    } catch (re) {
...
function JoinContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_join;
    return this;
}
...
JoinContext.prototype.LEFT = function() {
    return this.getToken(SiddhiQLGrammarParser.LEFT, 0);
};

JoinContext.prototype.OUTER = function() {
    return this.getToken(SiddhiQLGrammarParser.OUTER, 0);
};

JoinContext.prototype.JOIN = function() {
    return this.getToken(SiddhiQLGrammarParser.JOIN, 0);
};

JoinContext.prototype.RIGHT = function() {
    return this.getToken(SiddhiQLGrammarParser.RIGHT, 0);
};

JoinContext.prototype.FULL = function() {
    return this.getToken(SiddhiQLGrammarParser.FULL, 0);
};

JoinContext.prototype.INNER = function() {
    return this.getToken(SiddhiQLGrammarParser.INNER, 0);
};
...
SiddhiQLGrammarParser.prototype.join = function() {

    var localctx = new JoinContext(this, this._ctx, this.state);
    this.enterRule(localctx, 152, SiddhiQLGrammarParser.RULE_join);
    var _la = 0; // Token type
    try {
        this.state = 1017;
        switch(this._input.LA(1)) {
        case SiddhiQLGrammarParser.LEFT:
            this.enterOuterAlt(localctx, 1);
            this.state = 1002;
            this.match(SiddhiQLGrammarParser.LEFT);
            this.state = 1003;
            this.match(SiddhiQLGrammarParser.OUTER);
            this.state = 1004;
            this.match(SiddhiQLGrammarParser.JOIN);
            break;
        case SiddhiQLGrammarParser.RIGHT:
            this.enterOuterAlt(localctx, 2);
            this.state = 1005;
            this.match(SiddhiQLGrammarParser.RIGHT);
            this.state = 1006;
            this.match(SiddhiQLGrammarParser.OUTER);
            this.state = 1007;
            this.match(SiddhiQLGrammarParser.JOIN);
        ...
        case SiddhiQLGrammarParser.FULL:
            this.enterOuterAlt(localctx, 3);
            this.state = 1008;
            this.match(SiddhiQLGrammarParser.FULL);
            this.state = 1009;
            this.match(SiddhiQLGrammarParser.OUTER);
            this.state = 1010;
            this.match(SiddhiQLGrammarParser.JOIN);
        ...
        case SiddhiQLGrammarParser.INNER:
            ...
            this.state = 1014;
            _la = this._input.LA(1);
            if(_la===SiddhiQLGrammarParser.INNER) {
                this.state = 1013;
                this.match(SiddhiQLGrammarParser.INNER);
            }
...
function Constant_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_constant_value;
    return this;
}
...
SiddhiQLGrammarParser.prototype.constant_value = function() {

    var localctx = new Constant_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 154, SiddhiQLGrammarParser.RULE_constant_value);
    try {
        this.state = 1026;
...
function IdContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_id;
    return this;
}
...
IdContext.prototype.ID_QUOTES = function() {
    return this.getToken(SiddhiQLGrammarParser.ID_QUOTES, 0);
};

IdContext.prototype.ID = function() {
    return this.getToken(SiddhiQLGrammarParser.ID, 0);
};
...
SiddhiQLGrammarParser.prototype.id = function() {

    var localctx = new IdContext(this, this._ctx, this.state);
    this.enterRule(localctx, 156, SiddhiQLGrammarParser.RULE_id);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1028;
        _la = this._input.LA(1);
        if(!(_la===SiddhiQLGrammarParser.ID_QUOTES || _la===SiddhiQLGrammarParser.ID)) {
        this._errHandler.recoverInline(this);
        }
        this.consume();
    } catch (re) {
...
function KeywordContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_keyword;
    return this;
}
...
KeywordContext.prototype.YEARS = function() {
    return this.getToken(SiddhiQLGrammarParser.YEARS, 0);
};

KeywordContext.prototype.MONTHS = function() {
    return this.getToken(SiddhiQLGrammarParser.MONTHS, 0);
};

KeywordContext.prototype.WEEKS = function() {
    return this.getToken(SiddhiQLGrammarParser.WEEKS, 0);
};

KeywordContext.prototype.DAYS = function() {
    return this.getToken(SiddhiQLGrammarParser.DAYS, 0);
};

KeywordContext.prototype.HOURS = function() {
    return this.getToken(SiddhiQLGrammarParser.HOURS, 0);
};

KeywordContext.prototype.MINUTES = function() {
    return this.getToken(SiddhiQLGrammarParser.MINUTES, 0);
};

KeywordContext.prototype.SECONDS = function() {
    return this.getToken(SiddhiQLGrammarParser.SECONDS, 0);
};

KeywordContext.prototype.MILLISECONDS = function() {
    return this.getToken(SiddhiQLGrammarParser.MILLISECONDS, 0);
};

KeywordContext.prototype.FALSE = function() {
    return this.getToken(SiddhiQLGrammarParser.FALSE, 0);
};

KeywordContext.prototype.TRUE = function() {
    return this.getToken(SiddhiQLGrammarParser.TRUE, 0);
};
...
SiddhiQLGrammarParser.prototype.keyword = function() {

    var localctx = new KeywordContext(this, this._ctx, this.state);
    this.enterRule(localctx, 158, SiddhiQLGrammarParser.RULE_keyword);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1030;
        _la = this._input.LA(1);
        if(!(_la===SiddhiQLGrammarParser.STREAM || _la===SiddhiQLGrammarParser.DEFINE || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (SiddhiQLGrammarParser.TABLE - 32)) | (1 << (SiddhiQLGrammarParser.FROM - 32)) | (1 << (SiddhiQLGrammarParser.PARTITION - 32)) | (1 << (SiddhiQLGrammarParser.WINDOW - 32)) | (1 << (SiddhiQLGrammarParser.SELECT - 32)) | (1 << (SiddhiQLGrammarParser.GROUP - 32)) | (1 << (SiddhiQLGrammarParser.BY - 32)) | (1 << (SiddhiQLGrammarParser.HAVING - 32)) | (1 << (SiddhiQLGrammarParser.INSERT - 32)) | (1 << (SiddhiQLGrammarParser.DELETE - 32)) | (1 << (SiddhiQLGrammarParser.UPDATE - 32)) | (1 << (SiddhiQLGrammarParser.RETURN - 32)) | (1 << (SiddhiQLGrammarParser.EVENTS - 32)) | (1 << (SiddhiQLGrammarParser.INTO - 32)) | (1 << (SiddhiQLGrammarParser.OUTPUT - 32)) | (1 << (SiddhiQLGrammarParser.EXPIRED - 32)) | (1 << (SiddhiQLGrammarParser.CURRENT - 32)) | (1 << (SiddhiQLGrammarParser.SNAPSHOT - 32)) | (1 << (SiddhiQLGrammarParser.FOR - 32)) | (1 << (SiddhiQLGrammarParser.RAW - 32)) | (1 << (SiddhiQLGrammarParser.OF - 32)) | (1 << (SiddhiQLGrammarParser.AS - 32)) | (1 << (SiddhiQLGrammarParser.OR - 32)) | (1 << (SiddhiQLGrammarParser.AND - 32)) | (1 << (SiddhiQLGrammarParser.ON - 32)) | (1 << (SiddhiQLGrammarParser.IS - 32)) | (1 << (SiddhiQLGrammarParser.NOT - 32)) | (1 << (SiddhiQLGrammarParser.WITHIN - 32)) | (1 << (SiddhiQLGrammarParser.WITH - 32)) | (1 << (SiddhiQLGrammarParser.BEGIN - 32)))) !== 0) || ((((_la - 64)) & ~0x1f) == 0 && ((1 << (_la - 64)) & ((1 << (SiddhiQLGrammarParser.END - 64)) | (1 << (SiddhiQLGrammarParser.NULL - 64)) | (1 << (SiddhiQLGrammarParser.EVERY - 64)) | (1 << (SiddhiQLGrammarParser.LAST - 64)) | (1 << (SiddhiQLGrammarParser.ALL - 64)) | (1 << (SiddhiQLGrammarParser.FIRST - 64)) | (1 << (SiddhiQLGrammarParser.JOIN - 64)) | (1 << (SiddhiQLGrammarParser.INNER - 64)) | (1 << (SiddhiQLGrammarParser.OUTER - 64)) | (1 << (SiddhiQLGrammarParser.RIGHT - 64)) | (1 << (SiddhiQLGrammarParser.LEFT - 64)) | (1 << (SiddhiQLGrammarParser.FULL - 64)) | (1 << (SiddhiQLGrammarParser.UNIDIRECTIONAL - 64)) | (1 << (SiddhiQLGrammarParser.YEARS - 64)) | (1 << (SiddhiQLGrammarParser.MONTHS - 64)) | (1 << (SiddhiQLGrammarParser.WEEKS - 64)) | (1 << (SiddhiQLGrammarParser.DAYS - 64)) | (1 << (SiddhiQLGrammarParser.HOURS - 64)) | (1 << (SiddhiQLGrammarParser.MINUTES - 64)) | (1 << (SiddhiQLGrammarParser.SECONDS - 64)) | (1 << (SiddhiQLGrammarParser.MILLISECONDS - 64)) | (1 << (SiddhiQLGrammarParser.FALSE - 64)) | (1 << (SiddhiQLGrammarParser.TRUE - 64)) | (1 << (SiddhiQLGrammarParser.STRING - 64)) | (1 << (SiddhiQLGrammarParser.INT - 64)) | (1 << (SiddhiQLGrammarParser.LONG - 64)) | (1 << (SiddhiQLGrammarParser.FLOAT - 64)) | (1 << (SiddhiQLGrammarParser.DOUBLE - 64)) | (1 << (SiddhiQLGrammarParser.BOOL - 64)) | (1 << (SiddhiQLGrammarParser.OBJECT - 64)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        this.consume();
    } catch (re) {
...
function Time_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_time_value;
    return this;
}
...
SiddhiQLGrammarParser.prototype.time_value = function() {

    var localctx = new Time_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 160, SiddhiQLGrammarParser.RULE_time_value);
    try {
        this.state = 1124;
...
function Year_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_year_value;
    return this;
}
...
SiddhiQLGrammarParser.prototype.year_value = function() {

    var localctx = new Year_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 162, SiddhiQLGrammarParser.RULE_year_value);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1126;
        this.match(SiddhiQLGrammarParser.INT_LITERAL);
        this.state = 1127;
        this.match(SiddhiQLGrammarParser.YEARS);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Month_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_month_value;
    return this;
}
...
SiddhiQLGrammarParser.prototype.month_value = function() {

    var localctx = new Month_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 164, SiddhiQLGrammarParser.RULE_month_value);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1129;
        this.match(SiddhiQLGrammarParser.INT_LITERAL);
        this.state = 1130;
        this.match(SiddhiQLGrammarParser.MONTHS);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Week_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_week_value;
    return this;
}
...
SiddhiQLGrammarParser.prototype.week_value = function() {

    var localctx = new Week_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 166, SiddhiQLGrammarParser.RULE_week_value);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1132;
        this.match(SiddhiQLGrammarParser.INT_LITERAL);
        this.state = 1133;
        this.match(SiddhiQLGrammarParser.WEEKS);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Day_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_day_value;
    return this;
}
...
SiddhiQLGrammarParser.prototype.day_value = function() {

    var localctx = new Day_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 168, SiddhiQLGrammarParser.RULE_day_value);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1135;
        this.match(SiddhiQLGrammarParser.INT_LITERAL);
        this.state = 1136;
        this.match(SiddhiQLGrammarParser.DAYS);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Hour_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_hour_value;
    return this;
}
...
SiddhiQLGrammarParser.prototype.hour_value = function() {

    var localctx = new Hour_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 170, SiddhiQLGrammarParser.RULE_hour_value);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1138;
        this.match(SiddhiQLGrammarParser.INT_LITERAL);
        this.state = 1139;
        this.match(SiddhiQLGrammarParser.HOURS);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Minute_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_minute_value;
    return this;
}
...
SiddhiQLGrammarParser.prototype.minute_value = function() {

    var localctx = new Minute_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 172, SiddhiQLGrammarParser.RULE_minute_value);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1141;
        this.match(SiddhiQLGrammarParser.INT_LITERAL);
        this.state = 1142;
        this.match(SiddhiQLGrammarParser.MINUTES);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Second_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_second_value;
    return this;
}
...
SiddhiQLGrammarParser.prototype.second_value = function() {

    var localctx = new Second_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 174, SiddhiQLGrammarParser.RULE_second_value);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1144;
        this.match(SiddhiQLGrammarParser.INT_LITERAL);
        this.state = 1145;
        this.match(SiddhiQLGrammarParser.SECONDS);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Millisecond_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_millisecond_value;
    return this;
}
...
SiddhiQLGrammarParser.prototype.millisecond_value = function() {

    var localctx = new Millisecond_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 176, SiddhiQLGrammarParser.RULE_millisecond_value);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1147;
        this.match(SiddhiQLGrammarParser.INT_LITERAL);
        this.state = 1148;
        this.match(SiddhiQLGrammarParser.MILLISECONDS);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Signed_double_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_signed_double_value;
    return this;
}
...
Signed_double_valueContext.prototype.DOUBLE_LITERAL = function() {
    return this.getToken(SiddhiQLGrammarParser.DOUBLE_LITERAL, 0);
};
...
SiddhiQLGrammarParser.prototype.signed_double_value = function() {

    var localctx = new Signed_double_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 178, SiddhiQLGrammarParser.RULE_signed_double_value);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1151;
        _la = this._input.LA(1);
        if(_la===SiddhiQLGrammarParser.PLUS || _la===SiddhiQLGrammarParser.MINUS) {
            this.state = 1150;
            _la = this._input.LA(1);
            if(!(_la===SiddhiQLGrammarParser.PLUS || _la===SiddhiQLGrammarParser.MINUS)) {
            this._errHandler.recoverInline(this);
        ...
        this.state = 1153;
        this.match(SiddhiQLGrammarParser.DOUBLE_LITERAL);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Signed_long_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_signed_long_value;
    return this;
}
...
Signed_long_valueContext.prototype.LONG_LITERAL = function() {
    return this.getToken(SiddhiQLGrammarParser.LONG_LITERAL, 0);
};
...
SiddhiQLGrammarParser.prototype.signed_long_value = function() {

    var localctx = new Signed_long_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 180, SiddhiQLGrammarParser.RULE_signed_long_value);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1156;
        ...
        this.state = 1158;
        this.match(SiddhiQLGrammarParser.LONG_LITERAL);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Signed_float_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_signed_float_value;
    return this;
}
...
Signed_float_valueContext.prototype.FLOAT_LITERAL = function() {
    return this.getToken(SiddhiQLGrammarParser.FLOAT_LITERAL, 0);
};
...
SiddhiQLGrammarParser.prototype.signed_float_value = function() {

    var localctx = new Signed_float_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 182, SiddhiQLGrammarParser.RULE_signed_float_value);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1161;
        ...
        this.state = 1163;
        this.match(SiddhiQLGrammarParser.FLOAT_LITERAL);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
function Signed_int_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_signed_int_value;
    return this;
}
...
SiddhiQLGrammarParser.prototype.signed_int_value = function() {

    var localctx = new Signed_int_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 184, SiddhiQLGrammarParser.RULE_signed_int_value);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1166;
...
function Bool_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_bool_value;
    return this;
}
...
SiddhiQLGrammarParser.prototype.bool_value = function() {

    var localctx = new Bool_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 186, SiddhiQLGrammarParser.RULE_bool_value);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1170;
        _la = this._input.LA(1);
        if(!(_la===SiddhiQLGrammarParser.FALSE || _la===SiddhiQLGrammarParser.TRUE)) {
        this._errHandler.recoverInline(this);
        }
        this.consume();
    } catch (re) {
...
function String_valueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = SiddhiQLGrammarParser.RULE_string_value;
    return this;
}
...
String_valueContext.prototype.STRING_LITERAL = function() {
    return this.getToken(SiddhiQLGrammarParser.STRING_LITERAL, 0);
};
...
SiddhiQLGrammarParser.prototype.string_value = function() {

    var localctx = new String_valueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 188, SiddhiQLGrammarParser.RULE_string_value);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 1172;
        this.match(SiddhiQLGrammarParser.STRING_LITERAL);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
SiddhiQLGrammarParser.prototype.sempred = function(localctx, ruleIndex, predIndex) {
	switch(ruleIndex) {
	case 28:
...
SiddhiQLGrammarParser.prototype.every_pattern_source_chain_sempred = function(localctx, predIndex) {
	switch(predIndex) {
		case 0:
...
SiddhiQLGrammarParser.prototype.pattern_source_chain_sempred = function(localctx, predIndex) {
	switch(predIndex) {
		case 1:
...
SiddhiQLGrammarParser.prototype.sequence_source_chain_sempred = function(localctx, predIndex) {
	switch(predIndex) {
		case 2:
			return this.precpred(this._ctx, 2);
		default:
...
SiddhiQLGrammarParser.prototype.math_operation_sempred = function(localctx, predIndex) {
	switch(predIndex) {
		case 3:
...
exports.SiddhiQLGrammarParser = SiddhiQLGrammarParser;
