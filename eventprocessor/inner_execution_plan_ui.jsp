    ...
    <%
        if (mode.equals("ADD")) {
            ...
            if (executionPlanName != null) {
                EventProcessorAdminServiceStub stub = EventProcessorUIUtils
                        .getEventProcessorAdminService(config, session, request);
        ...
        EventStreamAdminServiceStub streamAdminServiceStub =
                EventProcessorUIUtils.getEventStreamAdminService(config, session, request);
                    ...
                    <td>
                        <table>
                            ...
                            <td><select id="importedStreamId" onfocus="this.selectedIndex = 0;"
                                ...
                                %>
                                <option value="createStreamDef">-- Create Stream Definition --
                                </option>
                            </select>
                            </td>
                    ...
                    <td colspan="2">
                        ...
                        <table width="100%" style="border: 1px solid #cccccc">
                            <tr>
                                ...
                                <pre class="queryExpressionsTextArea"
                                     style="width:100%; height: 150px"
                                     id="editor"
                                     name="queryExpressions"
                                     onblur="window.queryEditor.save()"><%=executionPlan%></pre>
